(function (f) {
  ...
  */
        ...
        { advarr: 4, "declare-vars": 1, deconcat: 5, "deep-counter": 6, "deepest-walk": 8, "min-quote": 9, "n-gram-counter": 10, separo: 12, striptags: 13, textops: 14, "var-names": 15 }
      ],
      4: [
        function (require, module, exports) {
            ...
            try {
              ...
              return inpt[func]((value, i, array) => {
                return cb({
                  ...
                  get before() {
                    return originalArray.slice(0, i);
                  },
                  get after() {
                    return originalArray.slice(i + 1);
                  },

                  brk: (n = 1) => {
                    throw `[advarr] breaking ${n}`;
                  },
      ...
      6: [
        function (require, module, exports) {
          ...
          const count = options => {
            let { data, debug_level = 0, count_numbers = true, count_strings = true, split_strings_on = " " } = options;
      ...
      8: [
        function (require, module, exports) {
          ...
          function walk({
            ...
            const split_str = str => map(str.split(split_strings_on), ({ it, first }) => (include_sep && !first ? split_strings_on : "") + it);
            ...
            if (isAry(data)) {
              ...
              if (!hasPath) {
                const dataType = data === undefined ? "undefined" : data === null ? "null" : typeof data === "number" ? "number" : undefined;
    ...
    "yield"
          ...
          function* genVarNames(
            { chars = DEFAULT_CHARS, debug = false, language = DEFAULT_LANG, max_count = DEFAULT_MAX_COUNT } = {
              chars: DEFAULT_CHARS,
              debug: false,
            ...
            while (true) {
              ...
              if (indexes[indexes.length - 1] === chars.length - 1) {
                ...
                if (reset_index === null) {
                  if (debug) console.log("[var-names] adding a character and resetting to all A's");
              ...
              if (reserved_words.has(new_variable_name)) {
                if (debug) console.log("[var-names] skipping " + new_variable_name + "because it is a reserved word");
                continue;
              }
